 ...
 * Use the [InventoryManagementFragment.newInstance] factory method to
...
class InventoryManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InventoryManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InventoryManagementFragment().apply {
